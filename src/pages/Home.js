...
export const Home = () => {
    ...
    return (
        ...
        <React.Fragment>
                            ...
                            <div className="col-lg-12">
                                <nav className="navbar navbar-expand-lg">
                                    ...
                                    <div className="collapse navbar-collapse sub-menu-bar" id="navbarOne">
                                        <ul className="navbar-nav m-auto">
                                            <li className="nav-item active">
                                                <a className="page-scroll" to="/home">HOME</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="page-scroll" to="/service">SERVICES</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="page-scroll" to="/pricing">PRICING</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="page-scroll" to="/testimonial">Testimonial</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="page-scroll" to="/contact">CONTACT</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="navbar-social d-none d-sm-flex align-items-center">
                                        <span>FOLLOW US</span>
                                        <ul>
                                            <li><a to="/"><i className="lni-facebook-filled"></i></a></li>
                                            <li><a to="/"><i className="lni-twitter-original"></i></a></li>
                                            <li><a to="/"><i className="lni-instagram-original"></i></a></li>
                                            <li><a to="/"><i className="lni-linkedin-original"></i></a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                            ...
                            <div className="col-xl-8 col-lg-10">
                                <div className="header-content text-center">
                                    ...
                                    <ul className="header-btn rounded-buttons">
                                        <li><a className="main-btn rounded-three" to="/">GET IN TOUCH</a></li>
                                        <li><a className="main-btn rounded-four video-popup" to="../../watch.html?v=r44RKWyfcFw">WATCH THE VIDEO <i className="lni-play"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-7 col-sm-9">
                            <div className="single-pricing mt-40">
                                ...
                                <div className="pricing-btn text-center">
                                    <a className="main-btn" to="/">GET STARTED</a>
                                </div>
                            ...
                            <div className="single-pricing pro mt-40">
                                ...
                                <div className="buttom-shape">
                                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 350 112.35"><defs>
                                        ...
                                        </defs><title>bottom-part1</title><g id="bottom-part"><g id="Group_747" data-name="Group 747">
                                            <path id="Path_294" data-name="Path 294" className="cls-1 color-2" style={{ fill:'/0067f4',isolation:"isolate",opacity:"0.1"}}d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z" transform="translate(0 0)"></path>
                                            <path id="Path_297" data-name="Path 297" className="cls-2 color-2" style={{ fill:'/0067f4',isolation:"isolate",opacity:"0.2"}}d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z" transform="translate(0 0)"></path>
                                            <path id="Path_296" data-name="Path 296" className="cls-3 color-2" style={{ fill:'/0067f4',isolation:"isolate",opacity:"0.4"}} d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z" transform="translate(0 0)"></path>
                                            <path id="Path_295" data-name="Path 295" className="cls-4 color-2" style={{ fill:'/0067f4',isolation:"isolate",opacity:"0.6"}}d="M349.17,54.21c-120-55.74-214.32,2.57-267,0S0,37.4,0,37.4v74.95H349.17Z" transform="translate(0 0)"></path></g></g></svg>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-7 col-sm-9">
                                ...
                                <div className="buttom-shape">
                                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 350 112.35"><defs>
                                        {/* <style>.color-2{fill:/0067f4;isolation:isolate;}.cls-1{opacity:0.1;}.cls-2{opacity:0.2;}.cls-3{opacity:0.4;}.cls-4{opacity:0.6;}</style> */}
                                            ...
                                            <path id="Path_294" data-name="Path 294" className="cls-1 color-3" style={{ fill:'#4da422',isolation:"isolate",opacity:"0.1"}}d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z" transform="translate(0 0)"></path>
                                            <path id="Path_297" data-name="Path 297" className="cls-2 color-3" style={{ fill:'#4da422',isolation:"isolate",opacity:"0.2"}}d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z" transform="translate(0 0)"></path>
                                            <path id="Path_296" data-name="Path 296" className="cls-3 color-3" style={{ fill:'#4da422',isolation:"isolate",opacity:"0.4"}} d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z" transform="translate(0 0)"></path>
                                            <path id="Path_295" data-name="Path 295" className="cls-4 color-3" style={{ fill:'#4da422',isolation:"isolate",opacity:"0.6"}}d="M349.17,54.21c-120-55.74-214.32,2.57-267,0S0,37.4,0,37.4v74.95H349.17Z" transform="translate(0 0)"></path></g></g></svg>
                                </div>
                            </div>
                        </div>
                </div></div>
                            ...
                            <div className="col-lg-12">
                                <div className="footer-logo-support d-md-flex align-items-end justify-content-between">
                                    <div className="footer-logo d-flex align-items-end">
                                        <a className="mt-30" to="index.html"><img src="assets/images/logo.svg" alt="Logo"/></a>
                            ...
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="footer-link">
                                    ...
                                    <ul>
                                        ...
                                        <li><a to="/">Business</a></li>
                                        <li><a to="/">Developer</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="copyright text-center">
                                    <p className="text">Template Crafted by <a rel="nofollow" to="../../index.htm">UIdeck</a> - UI Powered by <a el="nofollow" to="../../index-1.htm">AyroUI</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <a className="back-to-top" to="/"><i className="lni-chevron-up"></i></a>
